...
optionsCommon = ' --out_pre '+out_pre+' --spec '+spec+' --AccuracyBoost '+str(AccuracyBoost)+' --templateIni '+templateIni
i = 0
nowCommand = ''
...
nowCommand += ' python '+os.environ['FISHER_DIR']+'bin/cluster-submit/makeDerivs_axionCAMB_script.py '+options+';'
