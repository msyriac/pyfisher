...
pyfisher.write_fisher(f'{args.output}_planck_low_ell_TT_fullsky.txt',F1,delim=',')
pyfisher.write_fisher(f'{args.output}_planck_high_ell_TTEETE_fullsky.txt',F2,delim=',')
